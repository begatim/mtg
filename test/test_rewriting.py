...
def axiom():
    return produce(Plant(), BS(), Internode(), Segment(), 
                   [Internode(), Segment()], 
                   GrowthPoint(), 
                   [Internode(), Segment()], 
                   Internode(), Segment() )
...
def test3():
    class MySimu(MTGLsystem):
        ...
        def axiom(self):
            return produce(Plant(), BS(bid = 1), 
                           Internode(), Segment(), 
                           [Internode(), Segment()], 
                           BS(bid=2), Internode, Segment, 
                           [Internode(), Segment()] , Internode(), Segment() )
...
def test4():
    class MySimu(MTGLsystem):
        ...
        def axiom(self):
            return produce(
                Plant(), BS(), Internode(), Segment(), 
                [Internode(), Segment()], 
                GrowthPoint(), 
                [Internode(), Segment()] , 
                Segment(), Internode(), Segment() )
